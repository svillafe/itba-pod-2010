...
public class Test4 implements Runnable {
	...
	public static void main(String[] args) {
		...
		if (args.length == 1) {
			new Test4(args[0]).run();
		} else if (args.length == 2) {
			new Test4(args[0], args[1]).run();
		} else {
			new Test4(args[0], args[1], args[0]).run();
		}
	}

	public Test4(String localIp, String remoteIp, String add) {
		this.localIp = localIp;
		this.remoteIp = remoteIp;
		this.addAgent = true;
	}

	public Test4(String localIp, String remoteIp) {
		this.localIp = localIp;
		this.remoteIp = remoteIp;
	}

	public Test4(String localIp) {
		this.localIp = localIp;
	}
	...
	public void run() {
		...
		Resource lala = new Resource("Alloy", "Lala");
