...
public class Test3 implements Runnable {
	...
	public static void main(String[] args) {
		...
		if (args.length == 1) {
			new Test3(args[0]).run();
		} else if (args.length == 2) {
			new Test3(args[0], args[1]).run();
		} else {
			new Test3(args[0], args[1], args[0]).run();
		}
	}

	public Test3(String localIp, String remoteIp, String add) {
		this.localIp = localIp;
		this.remoteIp = remoteIp;
		this.addAgent = true;
	}

	public Test3(String localIp, String remoteIp) {
		this.localIp = localIp;
		this.remoteIp = remoteIp;
	}

	public Test3(String localIp) {
		this.localIp = localIp;
	}
