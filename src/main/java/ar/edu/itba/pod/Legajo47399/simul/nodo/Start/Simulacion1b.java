	...
	public static void main(String[] args) {
		...
		/*	try {
			...
			try {
			    ...
			    salida.println("Las transacciones por segundo fueron: "
					+ market.market().marketData().getHistory()
							.getTransactionsPerSecond()+"El contador da:"+contador+"Fecha:"+System.currentTimeMillis());
			    salida.close();
			}
